...
После создания простой системы аутентификации и регистрации пользователей вы ограничили доступ пользователей к некоторым страницам, для этого использовался декоратор **@login\_required**. Затем данные были связаны с конкретными пользователями при помощи отношения внешнего ключа. Вы также узнали, как выполнить миграцию базы данных, когда миграция требует ввести данные по умолчанию.
